...
let debug = require('debug')('digs-local:localdevice');
...
class LocalDevice extends DigsEmitter {
   ...
   * @summary Represents a development localdevice connected to the digs server.
  ...
  /**
   * Starts the localdevice by forking J5.
